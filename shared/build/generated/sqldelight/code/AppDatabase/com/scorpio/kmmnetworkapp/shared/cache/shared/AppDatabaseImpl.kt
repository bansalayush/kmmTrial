package com.scorpio.kmmnetworkapp.shared.cache.shared

import com.scorpio.kmmnetworkapp.shared.cache.AppDatabase
import com.scorpio.kmmnetworkapp.shared.cache.AppDatabaseQueries
import com.scorpio.kmmnetworkapp.shared.cache.Rocket
import com.scorpio.kmmnetworkapp.shared.cache.SelectAllLaunchesInfo
...
private class AppDatabaseQueriesImpl(
  ...
  override fun <T : Any> selectAllLaunchesInfo(mapper: (
    ...
    name: String?,
    type: String?
  ) -> T): Query<T> = Query(-119343965, selectAllLaunchesInfo, driver, "AppDatabase.sq",
  ...
  override fun insertLaunch(
    ...
    notifyQueries(-364088867, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }
  ...
  override fun insertRocket(
    ...
    notifyQueries(-179923714, {database.appDatabaseQueries.selectRocketById +
        database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  override fun removeAllLaunches() {
    driver.execute(-1584036403, """DELETE FROM Launch""", 0)
    notifyQueries(-1584036403, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  override fun removeAllRockets() {
    driver.execute(-576608141, """DELETE FROM Rocket""", 0)
    notifyQueries(-576608141, {database.appDatabaseQueries.selectRocketById +
        database.appDatabaseQueries.selectAllLaunchesInfo})
  }
  ...
  private inner class SelectRocketByIdQuery<out T : Any>(
    ...
    override fun execute(): SqlCursor = driver.executeQuery(477786227, """
    |SELECT * FROM Rocket
    |WHERE id = ?
    """.trimMargin(), 1) {
      bindString(1, id)
